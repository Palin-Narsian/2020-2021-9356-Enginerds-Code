...
public class DriveModule {
    ...
    public final org.firstinspires.ftc.teamcode.onewheel.ModuleSide moduleSide;
    ...
    public double MAX_MOTOR_POWER = 0.1;
    ...
    public DriveModule(Robot robot, org.firstinspires.ftc.teamcode.onewheel.ModuleSide moduleSide) {
        this.robot = robot;
    ...
    public void updateTarget (Vector2d transVec, double rotMag) { //translation vector and rotation magnitude
        ...
        Vector2d transVecFC = transVec.rotateBy(robot.getRobotHeading().getAngle(), org.firstinspires.ftc.teamcode.onewheel.Angle.Direction.COUNTER_CLOCKWISE); //was converted robot heading, was clockwise

        //vector needed to rotate robot at the desired magnitude
        //based on positionVector of module (see definition for more info)
        Vector2d rotVec = positionVector.normalize(rotMag).rotateBy(90, org.firstinspires.ftc.teamcode.onewheel.Angle.Direction.COUNTER_CLOCKWISE); //theoretically this should be rotated 90, not sure sure it doesn't need to be
    ...
    public double getPivotComponent (Vector2d targetVector, org.firstinspires.ftc.teamcode.onewheel.Angle currentAngle) {
        org.firstinspires.ftc.teamcode.onewheel.Angle targetAngle = targetVector.getAngle();
        ...
        org.firstinspires.ftc.teamcode.onewheel.Angle.Direction direction = currentAngle.directionTo(targetAngle);
        ...
        if (angleDiff < ALLOWED_MODULE_ORIENTATION_ERROR) {
            ...
            if (direction == org.firstinspires.ftc.teamcode.onewheel.Angle.Direction.CLOCKWISE) return ROT_ADVANTAGE;
            else return -1 * ROT_ADVANTAGE;
        } else {
            //scale module rotation power based on set constants
            if (direction == org.firstinspires.ftc.teamcode.onewheel.Angle.Direction.CLOCKWISE) return angleDiff / ANGLE_OF_MAX_MODULE_ROTATION_POWER * ROT_ADVANTAGE;
    ...
    public void setMotorPowers (Vector2d powerVector) {
        ...
        //CHECK THIS WAS CHANGED MIGHT BE WRONG
    ...
    public void rotateModule (Vector2d direction, boolean fieldCentric) {
        //converts robot heading to the angle type used by Vector2d class
        org.firstinspires.ftc.teamcode.onewheel.Angle convertedRobotHeading = robot.getRobotHeading().convertAngle(org.firstinspires.ftc.teamcode.onewheel.Angle.AngleType.NEG_180_TO_180_CARTESIAN);
    ...
    public org.firstinspires.ftc.teamcode.onewheel.Angle getCurrentOrientation() {
        ...
        return new org.firstinspires.ftc.teamcode.onewheel.Angle(rawAngle, Angle.AngleType.ZERO_TO_360_HEADING);
    }

...
public class Vector2d {
    ...
    public Vector2d(org.firstinspires.ftc.teamcode.onewheel.Angle angle) {
        this.x = Math.cos(Math.toRadians(angle.convertAngle(org.firstinspires.ftc.teamcode.onewheel.Angle.AngleType.NEG_180_TO_180_CARTESIAN).getAngle()));
        this.y = Math.sin(Math.toRadians(angle.convertAngle(org.firstinspires.ftc.teamcode.onewheel.Angle.AngleType.NEG_180_TO_180_CARTESIAN).getAngle()));
    }
    ...
    public org.firstinspires.ftc.teamcode.onewheel.Angle getAngle() {
        double angRad = Math.atan2(y, x);
        return new org.firstinspires.ftc.teamcode.onewheel.Angle(Math.toDegrees(angRad), org.firstinspires.ftc.teamcode.onewheel.Angle.AngleType.NEG_180_TO_180_CARTESIAN);
    }
    ...
    public Vector2d rotateBy(double ang, org.firstinspires.ftc.teamcode.onewheel.Angle.Direction direction) {
        double angRads;
        if (direction == org.firstinspires.ftc.teamcode.onewheel.Angle.Direction.COUNTER_CLOCKWISE) {

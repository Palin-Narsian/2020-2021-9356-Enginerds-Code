package org.firstinspires.ftc.teamcode.swerveteleop;
...
public class DriveModule {
    ...
    public void updateTarget (Vector2d transVec, double rotMag) { //translation vector and rotation magnitude
        ...
        Vector2d transVecFC = transVec.rotateBy(robot.getRobotHeading().getAngle(), Angle.Direction.COUNTER_CLOCKWISE); //was converted robot heading, was clockwise

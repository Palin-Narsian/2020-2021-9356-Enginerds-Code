...
public class Angle {
    ...
    enum AngleType {
        ZERO_TO_360_CARTESIAN, ZERO_TO_360_HEADING, NEG_180_TO_180_CARTESIAN, type, NEG_180_TO_180_HEADING
    }
    ...
    //CHANGED THIS MIGHT BE A PROBLEM.
    public double getAngle() {
        return this.convertAngle(AngleType.type).getAngle();
    }
